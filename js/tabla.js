...
export default function tabla() {
    ...
    return () =>{
        ...
        function agregarEnfiltro(...elem) {
            ...
            //let valorActual = filtro.value;
            for (let i of elem) {
                if (!existeEnJsonArray(arrFiltro, "option", i.colum2)) {
                    let option = document.createElement("option");
                    option.value = i.colum2;
                    option.innerHTML = i.colum2;
                    filtro.appendChild(option);
                    arrFiltro.push({ "option": i.colum2, "value": i.colum2 });
                }
            }
